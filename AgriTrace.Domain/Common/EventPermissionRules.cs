...
public static class EventPermissionRules
{
    ...
    {
        ["FARM"] = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "CREATED", "HARVEST" },
        ...
        ["SYSTEM"] = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "CREATED", "HARVEST", "RECEIVE", "PROCESSING", "PACKAGING", "TRANSPORT", "DISTRIBUTION", "RETAIL", "INSPECTION", "SPLIT", "MERGE", "RECALL" }
    };
